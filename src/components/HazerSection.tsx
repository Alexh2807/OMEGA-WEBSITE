  ...
  >
    ...
    <div className="space-y-6">
      ...
      <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-md font-light">
        ...
        inégalés.
        <br />
        <span className="font-medium text-white">90% de consommation de fluide en moins.</span>
        <br />
        <span className="font-medium text-white">Jusqu'à 40 heures de fonctionnement continu par litre.</span>
      </p>
    </div>
    ...
    <div className="grid grid-cols-3 gap-4 py-4 border-t border-b border-gray-700">
      ...
      <div className="text-center md:text-left">
        ...
        <div className="text-sm text-gray-400 uppercase tracking-wide">Efficacité accrue</div>
      </div>
      <div className="text-center md:text-left">
        <div className="text-4xl font-bold text-white mb-1">40h</div>
        <div className="text-sm text-gray-400 uppercase tracking-wide">Utilisation prolongée</div>
      </div>
      <div className="text-center md:text-left">
        <div className="text-4xl font-bold text-white mb-1">10</div>
        <div className="text-sm text-gray-400 uppercase tracking-wide">Ans de garantie</div>
      </div>
    </div>
    ...
    <div className="relative w-full max-w-lg lg:max-w-none">
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(ellipse 65% 35% at center, rgba(255, 255, 255, 0.08) 0%, transparent 70%)',
          filter: 'blur(30px)',
          borderRadius: '50%',
          opacity: 0.7,
        }}
...
const HazerSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="hazer-section"
      className="min-h-[60vh] bg-gradient-to-b from-black to-gray-900 flex items-center relative overflow-hidden text-white"
    >
