  ...
  return (
    ...
    >
      ...
      <header className="flex justify-between items-start mb-10 border-b-2 border-gray-800 pb-5">
        ...
        <div>
          ...
          <div className="text-sm text-gray-500">
            Fabricant français depuis 1996
          </div>
                 {' '}
        </div>
               {' '}
      ...
      <section className="grid grid-cols-2 gap-10 mb-10">
        ...
        <div>
          ...
          <div className="text-sm">
            ...
            <div className="mt-2">
                           {' '}
              <div>
                <span className="font-semibold">SIRET :</span> 481 088 722 00014
              </div>
                           {' '}
              <div>
                <span className="font-semibold">N° TVA :</span> FR74481088722
              </div>
                         {' '}
            </div>
                     {' '}
        ...
        <div>
          ...
          <div className="text-sm">
            ...
            {/* ✅ CORRECTION : Accès aux propriétés optionnelles via une assertion de type */}
                       {' '}
      ...
      <footer className="border-t border-gray-300 pt-5 text-xs text-gray-500">
               {' '}
        <p className="mb-2">
                    En cas de vente à un professionnel, pénalités de retard
          applicables au taux de 3 fois le taux d'intérêt légal et indemnité
          forfaitaire pour frais de recouvrement de 40€.        {' '}
        </p>
               {' '}
        <p>
                    Le vendeur reste propriétaire des biens vendus jusqu'au
          paiement complet de leur prix.        {' '}
        </p>
               {' '}
        <p className="mt-2">
                    Pour les biens vendus, le consommateur bénéficie de la
          garantie légale de conformité pour une durée de deux ans à compter de
          la délivrance du bien (articles L. 217-3 et suivants du code de la
          consommation).        {' '}
        </p>
             {' '}
      </footer>
