...
const AdminPlanningEditor: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div id="planning-export" className={isPrinting ? 'calendar-container-light' : 'calendar-container-dark'}>
            ...
            <FullCalendar
                ...
                view={'dayGrid'} // Utilise une vue générique 'dayGrid'
                duration={{ months: numberOfMonths }} // Contrôle la durée
                locale="fr"
                weekends={true}
                ...
                headerToolbar={{
                    ...
                    center: 'title',
                    right: '' // Les boutons sont gérés en externe maintenant
                }}
                buttonText={{ today: "Aujourd'hui" }}
                editable={true}
                selectable={true}
                selectMirror={true}
                dayMaxEvents={3} // Affiche 3 événements max par jour
                datesSet={handleDatesSet}
                select={handleSelect}
                dateClick={handleDateClick} // Gère le CTRL+Clic
      ...
      {activeTab === 'providers' && (
        <div className="space-y-6">
            {/* ... (UI gestion prestataires - inchangé) ... */}
