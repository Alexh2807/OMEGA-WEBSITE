...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setStats({
        users: { value: usersCount, change: 0 }, // Le changement d'utilisateurs n'est pas calculé ici pour la simplicité
        ...
        conversionRate: { value: conversionRate, change: 0 }, // Le changement de conversion n'est pas calculé
      });
