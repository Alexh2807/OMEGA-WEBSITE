...
export const productImages = [
  ...
  "/products/omega-dmx-px-hero-box.jpg",
  "/products/omega-dmx-real-controle.png",
  "/products/omega-dmx-real-3d-faisceaux.png",
  "/products/omega-dmx-real-couleur.png",
  "/products/omega-dmx-real-sortie-dmx.png",
  "/products/omega-dmx-real-effet-cercle.png",
  "/products/omega-dmx-real-connexion.png",
  "/products/omega-dmx-real-parametres.png",
  "/products/omega-dmx-px-soft-ui.jpg",
  "/products/omega-dmx-px-soft-stage.jpg",
  "/products/omega-dmx-px-soft-placement.jpg",
  "/products/omega-dmx-px-soft-live.png",
  "/products/omega-dmx-px-soft-color.jpg",
  "/products/omega-dmx-px-soft-move.jpg",
  "/products/omega-dmx-px-soft-plan.jpg",
